...
class ActionCheckPrice(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if (crop=='rice'):
            ...
            audio.save("rice_kannada.mp3")
            os.system("rice_kannada.mp3")
            ...
            language = 'kn'
            audio = gTTS(text=t_text1.text, lang=language, slow=False)
            audio.save("cotton_kannada.mp3")
            os.system("cotton_kannada.mp3")
            dispatcher.utter_message(text=t_text1.text)
            return []
            ...
            language = 'kn'
            audio = gTTS(text=t_text1.text, lang=language, slow=False)
            audio.save("jute_kannada.mp3")
            os.system("jute_kannada.mp3")
            dispatcher.utter_message(text=t_text1.text)
            return[]
...
class ActionFertilizerRecommendation(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        language = 'kn'
        audio = gTTS(text=t_text1.text, lang=language, slow=False)
        audio.save("frecomm_kannada.mp3")
        os.system("frecomm_kannada.mp3")
        dispatcher.utter_message(text=t_text1.text)
...
class ActionCropRecommendation(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        language = 'kn'
        audio = gTTS(text=t_text1.text, lang=language, slow=False)
        audio.save("crecom_kannada.mp3")
        os.system("crecom_kannada.mp3")
        dispatcher.utter_message(text=t_text1.text)
